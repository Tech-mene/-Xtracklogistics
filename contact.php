...
<!-- Start of Slider section
 ...
 <rs-module-wrap id="rev_slider_27_1_wrapper" data-alias="slider-7" data-source="gallery" style="visibility:hidden;background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
  <rs-module id="rev_slider_27_1" style="" data-version="6.5.8">
   <rs-slides>
    <rs-slide style="position: absolute;" data-key="rs-70" data-title="Slide" data-thumb="assets/slider-11.jpg" data-in="o:0;" data-out="a:false;">
   ...
   ><!-- Lpsum dolor sit amet, consectetur adipiscing elit, sed do eius-<br />
   mod tempor ut labore et dolore magna aliqua. -->
  </rs-layer>
  <a
  id="slider-27-slide-70-layer-5" 
  class="rs-layer rev-btn"
  href="about.html" target="_blank" rel="noopener"
  data-type="button"
  data-rsp_ch="on"
 ...
 <section id="ft-booking-form" class="ft-booking-form-section">
  <div class="container">
   <div class="ft-booking-form-content position-relative">
    <form method="GET" action="tracker_info.php">
     <div class="booking-form-input-wrapper d-flex justify-content-center flex-wrap">
      <label class="booking-form-input position-relative">
       ...
       <input type="text" name="tracker" placeholder="Your Tracking ID Now">
      </label>
     ...
     <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
      <div class="ft-about-img-exp position-relative">
       ...
       <div class="ft-about-img">
        <img src="assets/img/logistics.png" height="120" alt="">
       </div>
      </div>
     </div>
     <div class="col-lg-6">
      <div class="ft-about-text-wrapper">
       <div class="ft-section-title headline pera-content">
        ...
        <p>We have a deep commitment to always delivering first-class service. Whether we’re in the office, the warehouse, or on the road, our six core values drive us.</p>
       </div>
       <div class="ft-about-feature-list-warpper">
        <div class="ft-about-feature-list-item d-flex align-items-center wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
         ...
         <div class="ft-about-feature-text headline pera-content">
          ...
          <p>We always provide people a complete solution focused moving goods by truck, train, ship, or plane.
          </p>
         </div>
        </div>
        <div class="ft-about-feature-list-item d-flex align-items-center wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
         ...
         <div class="ft-about-feature-text headline pera-content">
          <h3>Local Service</h3>
          <p>We knowledge of the local terrain which enables us to provide unmatched secondary distribution service.
          </p>
         </div>
        </div>
       ...
       <div class="ft-why-choose-feature-wrapper">
        <div class="ft-why-choose-feature-item d-flex align-items-center wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
         ...
         <div class="ft-why-choose-feature-text headline pera-content">
          <h3>Royal Safety Transportion Service</h3>
          <p>We are not know for delays, we provide fast transportation to all destinations</p>
         </div>
        </div>
        <div class="ft-why-choose-feature-item d-flex align-items-center wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
         ...
         <div class="ft-why-choose-feature-text headline pera-content">
          <h3>Reliability</h3>
          <p>All items in our diposal are delivered in a timely and cost-effective manner.</p>
         </div>
        </div>
...
<!-- Start of Project section
 ...
 <section id="ft-project" class="ft-project-section position-relative">
  ...
  <div class="ft-project-slider-wrapper">
   <div class="ft-project-slider-area" style="margin: 130px;">
    <div class="ft-item-innerbox">
     <div class="ft-project-itembox position-relative">
      ...
      <div class="ft-project-text headline pera-content">
       ...
       Shipping </a></h3>
       <p>
Air freight parcel delivery is one areas which we have been successful in the the transfer and shipment of goods via an air carrier, which may be charter or commercial</p>
       <div class="ft-btn">
    ...
    <div class="ft-item-innerbox">
     <div class="ft-project-itembox position-relative">
      ...
      <div class="ft-project-text headline pera-content">
       <h3><a href="portfolio-single.html">Industrial And Air
       Shipping </a></h3>
       <p>Air freight parcel delivery is one areas which we have been successful in the the transfer and shipment of goods via an air carrier, which may be charter or commercial< </p>
       <div class="ft-btn">
        <a class="d-flex justify-content-center align-items-center" href="">Explore More</a>
       </div>
      </div>
